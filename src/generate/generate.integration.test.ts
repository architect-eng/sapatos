...
describe('Type Generation - End-to-End Integration Tests', () => {
  ...
  describe('Edge Cases and Validation', () => {
    ...
    it('generates valid TypeScript that would compile', async () => {
      ...
      expect(schema).toContain("declare module '@architect-eng/sapatos/schema'");
      expect(schema).toContain('interface StructureMap');
    ...
    it('generated types work with actual database queries', async () => {
      ...
      expect(schema).toMatchInlineSnapshot(`
        ...
        */
        ...
        declare module '@architect-eng/sapatos/schema' {
          ...
          type another_includedSQLExpression = 'another_included' | db.ColumnNames<StructureMap['another_included']['Updatable'] | (keyof StructureMap['another_included']['Updatable'])[]> | db.ColumnValues<StructureMap['another_included']['Updatable']> | StructureMap['another_included']['Whereable'] | StructureMap['another_included']['Column'] | db.ParentColumn | db.GenericSQLExpression;
            type comprehensiveSQLExpression = 'comprehensive' | db.ColumnNames<StructureMap['comprehensive']['Updatable'] | (keyof StructureMap['comprehensive']['Updatable'])[]> | db.ColumnValues<StructureMap['comprehensive']['Updatable']> | StructureMap['comprehensive']['Whereable'] | StructureMap['comprehensive']['Column'] | db.ParentColumn | db.GenericSQLExpression;
            type excluded_tableSQLExpression = 'excluded_table' | db.ColumnNames<StructureMap['excluded_table']['Updatable'] | (keyof StructureMap['excluded_table']['Updatable'])[]> | db.ColumnValues<StructureMap['excluded_table']['Updatable']> | StructureMap['excluded_table']['Whereable'] | StructureMap['excluded_table']['Column'] | db.ParentColumn | db.GenericSQLExpression;
            type included_tableSQLExpression = 'included_table' | db.ColumnNames<StructureMap['included_table']['Updatable'] | (keyof StructureMap['included_table']['Updatable'])[]> | db.ColumnValues<StructureMap['included_table']['Updatable']> | StructureMap['included_table']['Whereable'] | StructureMap['included_table']['Column'] | db.ParentColumn | db.GenericSQLExpression;
            type productsSQLExpression = 'products' | db.ColumnNames<StructureMap['products']['Updatable'] | (keyof StructureMap['products']['Updatable'])[]> | db.ColumnValues<StructureMap['products']['Updatable']> | StructureMap['products']['Whereable'] | StructureMap['products']['Column'] | db.ParentColumn | db.GenericSQLExpression;
            type some_tableSQLExpression = 'some_table' | db.ColumnNames<StructureMap['some_table']['Updatable'] | (keyof StructureMap['some_table']['Updatable'])[]> | db.ColumnValues<StructureMap['some_table']['Updatable']> | StructureMap['some_table']['Whereable'] | StructureMap['some_table']['Column'] | db.ParentColumn | db.GenericSQLExpression;
            type testSQLExpression = 'test' | db.ColumnNames<StructureMap['test']['Updatable'] | (keyof StructureMap['test']['Updatable'])[]> | db.ColumnValues<StructureMap['test']['Updatable']> | StructureMap['test']['Whereable'] | StructureMap['test']['Column'] | db.ParentColumn | db.GenericSQLExpression;
            type test_arraysSQLExpression = 'test_arrays' | db.ColumnNames<StructureMap['test_arrays']['Updatable'] | (keyof StructureMap['test_arrays']['Updatable'])[]> | db.ColumnValues<StructureMap['test_arrays']['Updatable']> | StructureMap['test_arrays']['Whereable'] | StructureMap['test_arrays']['Column'] | db.ParentColumn | db.GenericSQLExpression;
            type test_customSQLExpression = 'test_custom' | db.ColumnNames<StructureMap['test_custom']['Updatable'] | (keyof StructureMap['test_custom']['Updatable'])[]> | db.ColumnValues<StructureMap['test_custom']['Updatable']> | StructureMap['test_custom']['Whereable'] | StructureMap['test_custom']['Column'] | db.ParentColumn | db.GenericSQLExpression;
            type test_generatedSQLExpression = 'test_generated' | db.ColumnNames<StructureMap['test_generated']['Updatable'] | (keyof StructureMap['test_generated']['Updatable'])[]> | db.ColumnValues<StructureMap['test_generated']['Updatable']> | StructureMap['test_generated']['Whereable'] | StructureMap['test_generated']['Column'] | db.ParentColumn | db.GenericSQLExpression;
            type test_jsonSQLExpression = 'test_json' | db.ColumnNames<StructureMap['test_json']['Updatable'] | (keyof StructureMap['test_json']['Updatable'])[]> | db.ColumnValues<StructureMap['test_json']['Updatable']> | StructureMap['test_json']['Whereable'] | StructureMap['test_json']['Column'] | db.ParentColumn | db.GenericSQLExpression;
            type test_nullabilitySQLExpression = 'test_nullability' | db.ColumnNames<StructureMap['test_nullability']['Updatable'] | (keyof StructureMap['test_nullability']['Updatable'])[]> | db.ColumnValues<StructureMap['test_nullability']['Updatable']> | StructureMap['test_nullability']['Whereable'] | StructureMap['test_nullability']['Column'] | db.ParentColumn | db.GenericSQLExpression;
